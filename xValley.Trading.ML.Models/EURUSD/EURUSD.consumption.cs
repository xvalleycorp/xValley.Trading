...
namespace XValley_Trading_ML_Models
{
    public partial class EURUSD
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath(@"D:\Labs\ML.NET\TradingML\xValley.Trading\xValley.Trading.ML.Models\EURUSD\EURUSD.zip");
